            ...
            <div class="dashboard__component results">
                ...
                <div class="dashboard__component__content">
                    <div class="results__bar__container">
                        ...
                        <div class="dashboard__component__content__lign results__bar" id="results__bar__1" style="max-width: 75%;">
                        </div>
                        <div class="results__bar__container__images">
                            <img src="../public/img/achille.jpeg" title="Achille DAVID" alt="survey results image">
                            <img src="../public/img/thibaut.jpeg" title="Thibaut DUSAUTOIR" alt="survey results image">
                            <img src="../public/img/quentin.jpeg" title="Quentin GRANSART" alt="survey results image">
                        </div>
                    </div>
                    <div class="results__bar__container">
                        <p>Tacos - <span>1/4</span></p>
                        <div class="dashboard__component__content__lign results__bar" id="results__bar__2" style="max-width: 25%;">
                        </div>
                        <div class="results__bar__container__images">
                            <img src="../public/img/matthys.jpeg" title="Matthys BOUREAU" alt="survey results image">
                        </div>
                    </div>
                </div>
            </div>
